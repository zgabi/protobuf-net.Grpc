...
#pragma warning disable 1998
        ...
        public async ValueTask Shared_ValueTaskClientStreaming_CancellationToken_ValVoid(IAsyncEnumerable<HelloRequest> requestStream,
        ...
        public async IAsyncEnumerable<HelloReply> Shared_ServerStreaming_CancellationToken(HelloRequest request, CancellationToken cancellationToken)
        {
            yield return new HelloReply { Message = $"Hello {request.Name}" };
        }
        ...
        public async IAsyncEnumerable<HelloReply> Shared_ServerStreaming_CancellationToken_VoidVal(CancellationToken cancellationToken)
        {
            yield return new HelloReply { Message = $"Hello Anonymous Coward" };
        }
        ...
        public async IAsyncEnumerable<HelloReply> Shared_Duplex_CancellationToken(IAsyncEnumerable<HelloRequest> requestStream, CancellationToken cancellationToken)
        {
            await foreach (var request in requestStream)
                yield return new HelloReply { Message = $"Hello {request.Name}" };
        }
